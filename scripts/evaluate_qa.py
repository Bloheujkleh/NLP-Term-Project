...
def main() -> None:
    ...
    parser.add_argument("--generation-mode", choices=["extractive", "local_hf"], default="extractive")
    ...
    for item in gold:
        ...
        gold_citation_labels = {source["citation_label"] for source in item["gold_sources"]}
